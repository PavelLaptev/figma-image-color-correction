...
var fx = (function() {
    ...
    ;(function() {
      ...
      "
        ...
        if (
            !gl ||
            gl.getSupportedExtensions().indexOf("OES_texture_float_linear") !==
                -1
        ) {
            return
        }
    ...
    function initialize(width, height) {
        ...
        this._.extraTexture =
            this._.extraTexture || new Texture(0, 0, gl.RGBA, type)
  ...
  */
    ...
    exports.canvas = function() {
        ...
        canvas.adjustchannels = wrap(adjustchannels)
    ...
    var Shader = (function() {
      ...
      void main() {\
        ...
        Shader.prototype.drawRect = function(left, top, right, bottom) {
            ...
            right =
                right !== undefined ? (right - viewport[0]) / viewport[2] : 1
            bottom =
                bottom !== undefined ? (bottom - viewport[1]) / viewport[3] : 1
  ...
  "
    ...
    /**
     * @filter         Adjustchannels
     * @description    Gives the image a reddish-brown monochrome tint that imitates an old photograph.
     * @param amount   0 to 1 (0 for no effect, 1 for full sepia coloring)
     */
    function adjustchannels(r, g, b) {
        gl.adjustchannels =
            gl.adjustchannels ||
            new Shader(
                null,
    ...
    "
        ...
        simpleShader.call(this, gl.adjustchannels, {
            r: r,
            g: g,
            b: b,
        })
